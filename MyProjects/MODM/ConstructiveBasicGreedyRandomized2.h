#ifndef MODM_CONSTRUCTIVE_BasicGreedyRandomized2_H_
#define MODM_CONSTRUCTIVE_BasicGreedyRandomized2_H_
...
class ConstructiveBasicGreedyRandomized2: public Constructive<RepMODM, AdsMODM>
{
private:
...
public:
	...
	ConstructiveBasicGreedyRandomized2(ProblemInstance& _pMODM, double _alpha, RandGen& _rg, MODMADSManager& _adsMan) : // If necessary, add more parameters
	...
	virtual ~ConstructiveBasicGreedyRandomized2()
	{
	}
...
#endif /*MODM_CONTRUCTIVE_BasicGreedyRandomized2_H_*/
